 ...
 */
'use strict';(function(p,h){"object"===typeof exports&&"undefined"!==typeof module?module.exports=h():"function"===typeof define&&define.amd?define(h):p.React=h()})(this,function(){function p(a){for(var b=arguments.length-1,f="https://web.archive.org/web/20180828154326/https://reactjs.org/docs/error-decoder.html?invariant="+a,d=0;d<b;d++)f+="&args[]="+encodeURIComponent(arguments[d+1]);O(!1,"Minified React error #"+a+"; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ",
...
/*
     FILE ARCHIVED ON 15:43:26 Aug 28, 2018 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 541.036
  exclusion.robots: 0.089
  exclusion.robots.policy: 0.078
  cdx.remote: 0.07
  esindex: 0.01
  LoadShardBlock: 82.928 (3)
  PetaboxLoader3.datanode: 227.612 (5)
  load_resource: 372.556 (2)
  PetaboxLoader3.resolve: 152.7 (2)
*/