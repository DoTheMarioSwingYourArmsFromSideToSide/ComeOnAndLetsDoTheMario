...
function PackagesUtil(packagesStructure, query) {
    ...
    this.getVersionsByQuery = function(versionsObject) {
        ...
        function getVersionString(value) {
            if (/^\d+$/.test(value)) {
                return 'https://web.archive.org/web/20160923090649/http://localhost' + value;
            }
            if (/^[\d\.]+$/.test(value)) {
                return value;
            }
...
function instrument(serviceTopology, wixBiSession, queryUtil, siteModel, pageInfo) {
    ...
    var base = (serviceTopology.biServerUrl || 'https://web.archive.org/web/20160923090649/http://frog.wix.com').replace(/\/$/, '');
...
function miniPackages() {
    function fontsPrefetch() {
        ...
        pre.setAttribute('href', '//web.archive.org/web/20160923090649/https://fonts.googleapis.com');
...
function getViewerRjsConfig (serviceTopology) {
    ...
    var getIntegrationPath = function () {
        if (queryUtil.getParameterByName('ReactSource') === 'https://web.archive.org/web/20160923090649/http://localhost') {
            return 'https://web.archive.org/web/20160923090649/http://localhost:4578'
        } else {
            return 'https://web.archive.org/web/20160923090649/http://s3.amazonaws.com/integration-tests-statics/SNAPSHOT/runners'
        }
    };
    ...
    return {
        ...
        paths: {
            ...
            react: {min: serviceURL('react/0.14.3/react-with-addons.min'), source: '//web.archive.org/web/20160923090649/https://cdnjs.cloudflare.com/ajax/libs/react/0.14.3/react-with-addons'},
            reactDOM: {min: serviceURL('react/0.14.3/react-dom.min'), source: '//web.archive.org/web/20160923090649/https://cdnjs.cloudflare.com/ajax/libs/react/0.14.3/react-dom'},
            reactDOMServer: {min: serviceURL('react/0.14.3/react-dom-server.min'), source: '//web.archive.org/web/20160923090649/https://cdnjs.cloudflare.com/ajax/libs/react/0.14.3/react-dom-server'},
            ...
            io: 'https://web.archive.org/web/20160923090649/https://cdnjs.cloudflare.com/ajax/libs/socket.io/1.4.0/socket.io.min',
            ...
            pmrpc: '//web.archive.org/web/20160923090649/https://static.parastorage.com/services/pm-rpc/1.21.0/lib/pm-rpc',
...
/*global packagesUtil, instrument, queryUtil, overrideScriptsLocationMapFromQuery, prefetchPages, convertSiteModel, fixViewport, getFullRjsConfig, getViewerRjsConfig, getSubdomain, render, convertRendererModel, joinURL, addExperimentsFromQuery, getPageInfo, initExperimentTest*/
    ...
    serviceTopology.staticServerFallbackUrl = serviceTopology.staticServerFallbackUrl || 'https://web.archive.org/web/20160923090649/https://fallback.wix.com/';
...
/*
     FILE ARCHIVED ON 09:06:49 Sep 23, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 04:18:32 Jul 19, 2023.
...
/*
playback timings (ms):
  captures_list: 83.725
  exclusion.robots: 0.076
  exclusion.robots.policy: 0.066
  RedisCDXSource: 0.795
  esindex: 0.011
  LoadShardBlock: 63.004 (3)
  PetaboxLoader3.datanode: 105.418 (5)
  load_resource: 622.48 (2)
  PetaboxLoader3.resolve: 513.823 (2)
*/