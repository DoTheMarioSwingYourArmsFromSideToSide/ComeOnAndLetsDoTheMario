...
function Ektron_Ecommerce_ProductClass (id) {
        ...
        if (("undefined" != typeof fPtr) && (null != fPtr)){
            ...
            $ektron.ajax({
                ...
                success: function(ektronCallbackResult){
                    ...
                    Ektron_Ecommerce_ProductClass.GetObject(context).AjaxCallback_DisplayResult(removeZeroPipe, context);
                }
	        });
        }
    ...
    this.UpdatePrice = function (){
        ...
        var tbl = eval(priceTblObj.value);
        if (null == tbl)
            return;
...
/*
     FILE ARCHIVED ON 02:21:35 Jul 25, 2010 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 08:58:47 Jul 17, 2023.
...
/*
playback timings (ms):
  captures_list: 64.929
  exclusion.robots: 0.086
  exclusion.robots.policy: 0.075
  RedisCDXSource: 2.449
  esindex: 0.009
  LoadShardBlock: 37.513 (3)
  PetaboxLoader3.datanode: 65.911 (4)
  load_resource: 74.629
  PetaboxLoader3.resolve: 27.799
*/