...
(function(b,a){b.extend(true,gmwp.conf.cmp,{gmit_gf_map:{name:"gmit_gf_map",dataApiKey:"api-key",dataGoogleApiUrl:"google-api-url",initMapFunction:"window.gmitGfInitMap",latDrilldown:"coordinates.latitude",lngDrilldown:"coordinates.longitude",selector:".gmit-gf-map",listSelector:".gmit-gf-list",markerImgSrc:"https://web.archive.org/web/20171123172638/http://www.google.com/mapfiles/marker{label}.png"}});
...
/*
     FILE ARCHIVED ON 17:26:38 Nov 23, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 06:43:09 May 01, 2023.
...
/*
playback timings (ms):
  captures_list: 81.368
  exclusion.robots: 0.163
  exclusion.robots.policy: 0.145
  cdx.remote: 0.099
  esindex: 0.014
  LoadShardBlock: 37.598 (3)
  PetaboxLoader3.datanode: 72.907 (5)
  load_resource: 193.283 (2)
  PetaboxLoader3.resolve: 147.081 (2)
*/