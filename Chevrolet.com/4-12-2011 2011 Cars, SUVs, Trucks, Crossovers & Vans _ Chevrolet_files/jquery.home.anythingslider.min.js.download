...
(function($) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.buildNavigation = function() {
			...
			if (base.options.buildNavigation && (base.pages > 1)) {
				base.$items.filter(':not(.cloned)').each(function(i,el) {
					var index = i + 1,
						$a = $("<a></a>").addClass('panel' + index).wrap("<li />");
		...
		base.buildNextBackButtons = function() {
			...
			base.$forward = $('<span class="arrow forward"><a>' + base.options.forwardText + '</a></span>');
			base.$back = $('<span class="arrow back"><a>' + base.options.backText + '</a></span>');
			...
			base.$controls.prepend(base.$forward).prepend(base.$back);
		...
		base.goForward = function(autoplay) {
			...
			if(base.currentPage == base.pages){
				...
				// simulate a click on 1
				jQuery('.anythingSlider').find('.panel1').click();
		...
		base.goBack = function(autoplay) {
			...
			if(base.currentPage == 1){
				...
				// simulate a click on last
				jQuery('.anythingSlider').find(('.panel'+base.pages)).click();
...
/*
     FILE ARCHIVED ON 21:19:09 Apr 10, 2011 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:54:20 Apr 30, 2023.
...
/*
playback timings (ms):
  captures_list: 68.411
  exclusion.robots: 0.194
  exclusion.robots.policy: 0.173
  cdx.remote: 0.141
  esindex: 0.019
  LoadShardBlock: 39.741 (3)
  PetaboxLoader3.datanode: 71.25 (5)
  load_resource: 208.274 (2)
  PetaboxLoader3.resolve: 68.188 (2)
*/