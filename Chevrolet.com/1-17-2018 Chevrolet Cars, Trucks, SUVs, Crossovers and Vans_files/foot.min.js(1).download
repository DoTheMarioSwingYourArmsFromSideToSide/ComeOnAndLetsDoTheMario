...
(function(b,a){b.extend(true,gmwp.conf.cmp,{gmit_gf_map:{name:"gmit_gf_map",dataApiKey:"api-key",dataGoogleApiUrl:"google-api-url",initMapFunction:"window.gmitGfInitMap",latDrilldown:"coordinates.latitude",lngDrilldown:"coordinates.longitude",selector:".gmit-gf-map",listSelector:".gmit-gf-list",markerImgSrc:"https://web.archive.org/web/20180118013929/http://www.google.com/mapfiles/marker{label}.png"}});
...
/*
     FILE ARCHIVED ON 01:39:29 Jan 18, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 06:49:27 May 01, 2023.
...
/*
playback timings (ms):
  captures_list: 204.379
  exclusion.robots: 0.14
  exclusion.robots.policy: 0.126
  cdx.remote: 0.094
  esindex: 0.015
  LoadShardBlock: 163.443 (3)
  PetaboxLoader3.datanode: 156.641 (5)
  PetaboxLoader3.resolve: 290.661 (3)
  load_resource: 547.968 (2)
*/