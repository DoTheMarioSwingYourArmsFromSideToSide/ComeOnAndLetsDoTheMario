...
-------As Per Template Order----------
 mimpl-jquery,formatdate,datepicker,ada-datepicker,mimpl-js,custom,filter-js,optionvarify,tooltipster,home-map,pagination */ 
/* 
-------Database List----------
File: mimpl-jquery, SiteID: 12214
File: formatdate, SiteID: 12214
File: datepicker, SiteID: 12214
File: ada-datepicker, SiteID: 12214
File: mimpl-js, SiteID: 12214
File: custom, SiteID: 12214
File: filter-js, SiteID: 12214
File: optionvarify, SiteID: 12214
File: tooltipster, SiteID: 12214
File: home-map, SiteID: 12214
File: pagination, SiteID: 12214
 */
 /* 
-------cacheFileName----------
 keyC26FF352F1C17DAC7780581DAB4C60C7C32B5829FCD9F71777DF15073BAD6885#2023-05-05T21--07--11 */ 
...
var buttonImageFile = "https://web.archive.org/web/20230430081817/https://www.gaylordhotels.com/images_noindex/calendar.svg";
var buttonImageFile2 = "https://web.archive.org/web/20230430081817/https://www.gaylordhotels.com/images_noindex/calendar.svg";
...
$(document).ready(function() {
  ...
  if (document.getElementById('PREFERREDDATES1')) {
    ...
    if (document.getElementById('PREFERREDDATES2')) {
      ...
      if (document.getElementById('checkindate-private')) {
    $('#checkindate-private').val(getTodayDateFromPC("mm/dd/yyyy"));
  }
  
    if (document.getElementById('PRIVATEDININGDATE')) {
    $('#PRIVATEDININGDATE').val(getTodayDateFromPC("mm/dd/yyyy"));
  }
   ...
   if (document.getElementById('FROMDATE')) {
    ...
    if (document.getElementById('TODATE')) {
      ...
      if($("#FROMDATE").hasClass("displaynamechange")){
        $("."+$("#FROMDATE").attr("data-displayfield")).text($("#FROMDATE").val());
      }
      if($("#TODATE").hasClass("displaynamechange")){
        $("."+$("#TODATE").attr("data-displayfield")).text($("#TODATE").val());
      }
    }
  
  	if (document.getElementById('ACCOMMODATIONARRIVALDATE')) {
        $('#ACCOMMODATIONARRIVALDATE').val(getTodayDateFromPC("mm/dd/yyyy"));
    }
    if (document.getElementById('ACCOMMODATIONDEPARTUREDATE')) {
        $('#ACCOMMODATIONDEPARTUREDATE').val(getTodayDateFromPC("mm/dd/yyyy", 1));
    }
...
if (document.getElementById('checkindatenew')) {
    $('#checkindatenew').val(getTodayDateFromPC("mm/dd/yyyy"));
  }
  if (document.getElementById('checkoutdatenew')) {
    $('#checkoutdatenew').val(getTodayDateFromPC("mm/dd/yyyy", 1));
  }

  
  
  var datePickerString = '#checkindatenew, #checkoutdatenew,#checkindate, #checkindate-private, #checkoutdate, #checkindate1, #DATEPROPOSAL, #PREFERREDDATES1, #PREFERREDDATES2,#GPREFERREDDATES1, #GPREFERREDDATES2, #ALTERNATEDATES, #checkindate2, #checkoutdate2, #txtfromtop, #txttotop,#FROMDATE, #TODATE,#ACCOMMODATIONARRIVALDATE,#ACCOMMODATIONDEPARTUREDATE,#PRIVATEDININGDATE';  
...
setADARangeDate("checkindatenew","checkoutdatenew","Check in date view calendar","Check out date view calendar",buttonImageFile);
     setADADatepicker("#checkindate-private","Private Dining date view calendar",buttonImageFile);
  setADADatepicker("#PRIVATEDININGDATE","Private Dining date view calendar",buttonImageFile);
  ...
  setADARangeDate("ACCOMMODATIONARRIVALDATE","ACCOMMODATIONDEPARTUREDATE","Arrival date","Departure date",buttonImageFile);
    ...
    $('#'+Id1).datepicker({
      ...
      onClose: function() {
        ...
        if($(this).val() != "") {
          ...
          setNextDate(Id1, Id2);
          if($("#"+Id1).hasClass("displaynamechange")){
            $("."+$("#"+Id1).attr("data-displayfield")).text($("#"+Id1).val());
          }
          if($("#"+Id2).hasClass("displaynamechange")){
            $("."+$("#"+Id2).attr("data-displayfield")).text($("#"+Id2).val());
          }
        }
...
function closeDatePicker() {    
  if (isCloseDatePicker && device != "mobile") {
    ...
    $("#checkindate,#checkoutdate,#checkindate2,#checkoutdate2,#PREFERREDDATES1,#PREFERREDDATES2, #FROMDATE, #TODATE, #ACCOMMODATIONARRIVALDATE, #ACCOMMODATIONDEPARTUREDATE, #checkindate-private,#PRIVATEDININGDATE").datepicker("hide");
    $("#checkindate,#checkoutdate,#checkindate2,#checkoutdate2,#PREFERREDDATES1,#PREFERREDDATES2,#FROMDATE, #TODATE, #ACCOMMODATIONARRIVALDATE, #ACCOMMODATIONDEPARTUREDATE, #checkindate-private,#PRIVATEDININGDATE").blur();
    setTimeout(function () {
...
function navOnFunctionality(){
  ...
  $("a").each(function() {
    ...
    siteURL = "https://web.archive.org/web/20230430081817/https://www.gaylordhotels.com/";
...
function datalayerbind(){
  $.ajax({
    url: "https://web.archive.org/web/20230430081817/https://www.gaylordhotels.com/GetCountryBasedOnLocationHandler.ashx",  
    dataType: "json",
    data: "",
...
/******************************** MIMPL-CODE *******************************/
$(document).ready(function () {
  $('.filter-box.locationbtn').click(function(){
    $('#filter-by-topic').attr("hidden","");
    $('.filter-box.eventsbtn').attr("aria-expanded","false");
  });
   $('.filter-box.eventsbtn').click(function(){
    $('#filter-by-property').attr("hidden","");
     $('.filter-box.locationbtn').attr("aria-expanded","false");
  });
  setTimeout(function () {
    $('img').each(function () {
      var v = $(this).attr("alt");
  ...
  setTimeout(function () {
    ...
    $('#ot-host-lst button.ot-host-box').each(function () {
      if($(this).html()=="" || $(this).html()==" ")
      {
        $(this).remove();
      }
  ...
  $('[data-uk-slider]').each(function(){
    slidershowAda(this);
  });
  var swapUrl = $('#video-swap').attr('data-src');
  setTimeout(function(){
    $('#video-swap').attr('src',swapUrl);
  },1000);
  $('.expand-zigzag a').click(function(){
    $(this).toggleClass('active');
    $('.zizzag-stack-desc-long').slideToggle(500);
  });
  ...
  if($('.top-navigation ul li').length > 6 || $(window).width() < 961) {
  ...
  var firstNameSM = $('#FIRSTNAME').val();
  var lastNameSM = $('#LASTNAME') .val();
  var membershipNumberSM = $('#MEMBERSHIPNUMBER') .val();
  var companySM = $('#COMPANY').val();
  var streetNumberSM = $('#ADDRESS1') .val();
  var zipSM = $('#ZIP') .val();
  var citySM = $('#CITY').val();
  var countrySM = $('#COUNTRY') .val();
  var emailSM = $('#EMAIL') .val();
  var telephoneSM = $('#TELEPHONEWITHAREACODE') .val();
  $('.eventName').html(eventName);
  $('.fromDate').html(fromDate);
  $('.toDate').html(toDate);
  $('.firstNameSM').html(firstNameSM);
  $('.lastNameSM').html(lastNameSM);
  $('.membershipNumberSM').html(membershipNumberSM);
  $('.companySM').html(companySM);
  $('.streetNumberSM').html(streetNumberSM);
  $('.zipSM').html(zipSM);
  $('.citySM').html(citySM);
  $('.countrySM').html(countrySM);
  $('.emailSM').html(emailSM);
  $('.telephoneSM').html(telephoneSM);
});
...
function deferUikitJSLoad(srcUrl, callback) {
...
setTimeout(function(){
  deferUikitJSLoad('https://web.archive.org/web/20230430081817/https://www.gaylordhotels.com/js/mimpl-uikit-main.aspx', function() { 
    ...
    setTimeout(function(){
      UIkit.util.on(".home-contact__details .uk-accordion", 'show', function (e,ee) {
        var img = $(e.target).attr("data-img");
        $(".home-contact__map img").attr("src",img);
      });
      ...
      uiKitmodelADA();
      if($(".home-contact__details").length) {
        UIkit.accordion(".home-contact__details [data-uk-accordion]").toggle(0, false);
      }
    ...
    createSliderCount("#intro-slider");
    createSliderCount("#gallery-slider");
    createSliderCount("#diningslider");
    ...
    $(document).ready(function () {
      ...
      $('#main-navigation li.nav-title').each(function(i){
        var index  = i;
        $(this).hover(
          function () {
            $(".nav-img").removeClass("activenav");
            $(".nav-img").eq(index).addClass("activenav");
          }, 
          function () {
            $(".nav-img").removeClass("activenav");
            $(".nav-img").eq(1).addClass("activenav");
          }
        );
    ...
    window.onload = function() {
      /* Sticky Menu */
      /* Responsive Tabs */
      var tabElms = document.querySelectorAll('.js-res-tabs a');
      tabElms.forEach(function(elm){
        elm.onclick = function toggleTabDropdown(){
          if(document.querySelector('.js-res-tabs.is-open')){
            console.log(document.querySelector('.js-res-tabs.is-open'));
            document.querySelector('.js-res-tabs__action').innerText = elm.innerText;
            console.log('called...');
            UIkit.toggle("#home-roomtypes-tabs", {
              cls: 'is-open'
            });    
          }
        };
...
function slidershowAda(elementmain) {
  var element =  $(elementmain).find(".uk-slideshow-items")[0];
  if($(elementmain).find(".home-room-slider>li").length>1){
    $(elementmain).find(".service-card__slider-actions").addClass("slidenav-show");
  }
  else{
    $(elementmain).find(".service-card__slider-actions").removeClass("slidenav-show");
  }
}
function resercheck(){
  var selectedhotel = $('#resortselector').find('option:selected').val();
  if(selectedhotel =='')
  {
  ...
  {
    $('#hotelselected').val(selectedhotel);
    document.getElementById('desktopReservationForm').submit();
  }
}

function resercheck1(){
  var selectedhotel = $('#resortselector1').find('option:selected').val();
  if(selectedhotel =='')
  {
    alert('Please select Hotel');
  }
  ...
  {
    $('#hotelselected1').val(selectedhotel);
    document.getElementById('desktopReservationForm1').submit();
  }
}
...
function trapFocus(element) {
  ...
  $(".grid-box .button-readmore").click(function(){
    $(this).toggleClass("active");
    $(this).parents(".grid-box").find(".js-texttoggle-content").slideToggle(500); 
...
window.onload = function() {
  ...
  /* Responsive Tabs */
  var tabElms = document.querySelectorAll('.js-res-tabs4 a');
  tabElms.forEach(function(elm){
    elm.onclick = function toggleTabDropdown(){
      if(document.querySelector('.js-res-tabs4.is-open')){
        console.log(document.querySelector('.js-res-tabs4.is-open'));
        document.querySelector('.js-res-tabs__action4').innerText = elm.innerText;
        console.log('called...');
        UIkit.toggle("#home-roomtypes-tabs", {
          cls: 'is-open'
        });    
  ...
  var tabElms = document.querySelectorAll('.js-res-tabs2 a');
  tabElms.forEach(function(elm){
    elm.onclick = function toggleTabDropdown(){
      if(document.querySelector('.js-res-tabs2.is-open')){
        console.log(document.querySelector('.js-res-tabs2.is-open'));
        document.querySelector('.js-res-tabs__action2').innerText = elm.innerText;
        console.log('called...');
        UIkit.toggle("#home-roomtypes-tabs1", {
          cls: 'is-open'
        });    
      }
    };
...
$(window).on('load', function () {
  setTimeout(function(){
    ...
    if(consentPolicyLink.length > 0) {
      $('#msCookieBanner a').attr('href', 'https://web.archive.org/web/20230430081817/https://www.marriott.com/about/privacy.mi');
...
$(".readmore-lessbtn a.read-link").click(function (e) {
  e.preventDefault();
  $(this).toggleClass("read-active");
  $(this).closest('.home-h1block').find(".expandable_hiddentest").slideToggle("slow");
});


$(".tampa-marriott").hover(
  function () {
    $(".logo-group-section").addClass($(this).attr("data-class"));
  }, function () {
    $(".logo-group-section").removeClass($(this).attr("data-class"));
  });
...
setTimeout(function () {
  ...
  function filterChangeActivity() {
  
    $(".event-block").addClass("isVisible");
    var filte_box1 = $("#filter-by-property input[type='checkbox']:checked");
    var filte_box2 = $("#filter-by-topic  input[type='checkbox']:checked");
  
  
  
    if(filte_box2.length>0){
      filte_box2.each(function(){
        var text = $(this).val();
        var hold = $(".event-block.isVisible[data-eventtype*='" + text + "']");
  
        hold.addClass("isVisible_pass");
  
      });
  
      $(".event-block").removeClass("isVisible");
      $(".event-block.isVisible_pass").addClass("isVisible").removeClass("isVisible_pass");
  
      if(filte_box2.length>1){
        $(".eventsbtn span.changer").text(filte_box2.length+ ' options selected');
      }
      else{
        $(".eventsbtn span.changer").text(filte_box2.length+ ' option selected');
      }
    }
    else{
      $(".eventsbtn span.changer").text('Select an Option');
    }
  
    if(filte_box1.length>0){
      filte_box1.each(function(){
        var text = $(this).val();
        var hold = $(".event-block.isVisible[data-locationtype*='" + text + "']");
      ...
      if(filte_box1.length>1){
        $(".locationbtn span.changer").text(filte_box1.length+ ' options selected');
      }
      else{
        $(".locationbtn span.changer").text(filte_box1.length+ ' option selected');
      }
    }
    else{
      $(".locationbtn span.changer").text('Select an Option');
    }
    $(".activity-count").text($(".comeventlist:visible .event-block.isVisible:visible").length);
  
    setgridjsfunction();
createPager();
  }
  function setContentHeight1() {
    setHeightGroupByElementsByBlock(".grid-view-inner .grid-view-content", ".grid-desc", 3 /*2,3,4*/ );
    setHeightGroupByElementsByBlock(".tabs-data .tabbing-hotel-content", ".tabbing-hotel-title", 3);
    if ($(window).width() > 770) {
      expandView(3);
    } else if ($(window).width() > 765 && $(window).width() < 769) {
      expandView(2);
    } else {
      expandView(1);
    }
  }
  var eventnameisdone  = false;
  function expandView(checkinadd) {
    $(".splaceholder").remove();
    var k = 0;
    //var checkinadd = 3;
    if ($(".grid-view-content:last").find(".expand-tabbing-data").length <= 0) {
      return;
    }
    if ($(".grid-view-content.isVisible").length >= checkinadd) {
      var isthere = false;
      $(".grid-view-content.isVisible:visible").each(function(index, element) {
        isthere = true;
        if ((index + 1) % checkinadd == 0) {
          isthere = false;
          $(this).after("<div class='splaceholder' id='splaceholder" + k + "'></div>");
          k++;
        }
      });
      if (isthere) {
        $(".grid-view-content.isVisible:visible:last").after("<div class='splaceholder' id='splaceholder" + k + "'></div>");
      }
    } else {
      $(".grid-view-content:last").after("<div class='splaceholder' id='splaceholder" + k + "'></div>");
    }
    $(".tabbing-hotel-content").removeClass("active");
  
  
    if(getQuerystring("eventname") != ""&& !eventnameisdone){
      eventnameisdone = true;
      var eventname = decodeURIComponent(getQuerystring("eventname"));
  
      var eventsbo  = $(".tabbing-hotel-content .focus_a[data-event-name='"+eventname+"']");
      if(eventsbo.length){
        eventsbo.click();
  
        $("html, body").animate({ scrollTop: eventsbo.offset().top });
      }
    };
...
function createPager(){
  ...
  // var items = array;
  var numItems =  $(".event-block.isVisible").length;


 // var numItems = items.length;
  var perPage = 6;
$(".event-block.isVisible").show();
  $(".event-block.isVisible").slice(perPage).hide();
  ...
  if(!$('#pagination-container-first').data("pagination")){

    $('#pagination-container-first').pagination({
      items: numItems,
      itemsOnPage: perPage,

      //prevText: '<a href="javascript:;" class="prev-arrow"><span class="mim-icon-arrow"></span></a>',
      //nextText: '<a href="javascript:;" class="next-arrow"><span class="mim-icon-right-arrow1"></span></a>',
      onPageClick: function (pageNumber,e) {


        var showFrom = perPage * (pageNumber - 1);
        var showTo = showFrom + perPage;
         $(".event-block.isVisible").hide().slice(showFrom, showTo).show();
  
        var ofseted = 0;
        if($(".explore-articles-wrap").length>0){

          ofseted =$(".explore-articles-wrap").offset().top -$("#main").height();
        }
       /* $('html,body').animate({ 
          scrollTop: ofseted
        },200);
...
*/
    ...
    if(getQuerystring("pageno") != ""){
      var no =decodeURIComponent(getQuerystring("pageno"));
      if(parseInt(no) && Math.ceil(numItems/perPage)>=parseInt(no) ){
        var papeN = parseInt(no);
        $('#pagination-container-first').pagination('selectPage', papeN);
    ...
    $("#pagination-container-first").pagination('updateItems', numItems);
  }
  ...
  $(document).ready(function() {
    if(getQuerystring("pressnews") != ""){
      var events_new = getQuerystring("pressnews");

      events_new = decodeURIComponent(events_new).replaceAll("__mper__","&");
      events_new = events_new.split(",");

      events_new.forEach(function(ele){
        $("#filter-by-property-news input[value='"+ele+"']").prop("checked",true);
      });
    
      setTimeout(function(){
        if(  $("#filter-by-property-news input[value='"+events_new[0]+"']").length>0){
          $("#filter-by-property-news input[value='"+events_new[0]+"']").change();
        }
      },200);
      
    }
    if(getQuerystring("property") != ""){
      var events = getQuerystring("property");

      events = decodeURIComponent(events).replaceAll("__mper__","&");
      events = events.split(",");

      events.forEach(function(ele){
        $("#filter-by-property input[value='"+ele+"']").prop("checked",true);

      });
      var h = $(".filter-wrap").offset().top-$("header").height();
      $("html, body").animate({ scrollTop: h });
    }
    if(getQuerystring("topic") != ""){
      var events = getQuerystring("topic");

      events = decodeURIComponent(events).replaceAll("__mper__","&");
      events = events.split(",");

      events.forEach(function(ele){
        $("#filter-by-topic input[value='"+ele+"']").prop("checked",true);
      ...
      if(getQuerystring("property") == "" && getQuerystring("topic") == "" && getQuerystring("pressnews") != ""){
    setTimeout(function(){
          var h = $(".press-releases-filter").offset().top-$("header").height();
          $("html, body").animate({ scrollTop: h });
            },3500);
      }
    ...
    $(document).click(function (event) {
        ...
        if (!$target.closest('.filter-location, .filter-event-type').length && $('.filter-location, .filter-event-type').is(":visible")) {
            $(this).find('.fbox').hide();
          	$(this).find('.filter-box').attr("aria-expanded","false");
        }
    });
    
filterChangeActivity();
$(".news-list-item").addClass("isVisible");

    $("#filter-by-property input[type='checkbox']").change(function() {

      if($(this).val() == "All"){
        if($(this).prop("checked")){
          $("#filter-by-property input[type='checkbox']").prop("checked",true);
        }
        else{
          $("#filter-by-property input[type='checkbox']").prop("checked",false);
        }
      }
      else{
        $("#filter-by-property input[type='checkbox'][value='All']").prop("checked",false);
      }
      filterChangeActivity();
    });

    $("#filter-by-topic input[type='checkbox']").change(function() {

      if($(this).val() == "All"){
        if($(this).prop("checked")){
          $("#filter-by-topic input[type='checkbox']").prop("checked",true);
        }
        else{
          $("#filter-by-topic input[type='checkbox']").prop("checked",false);
        }
      }
      else{
        $("#filter-by-topic input[type='checkbox'][value='All']").prop("checked",false);
      }
      filterChangeActivity();
    ...
    $("#filter-by-property-news input[type='checkbox']").change(function() {

      if($(this).val() == "All"){
        if($(this).prop("checked")){
          $("#filter-by-property-news input[type='checkbox']").prop("checked",true);
        }
        else{
          $("#filter-by-property-news input[type='checkbox']").prop("checked",false);
        }
      }
      else{
        $("#filter-by-property-news input[type='checkbox'][value='All']").prop("checked",false);
      }

      var filte_box2 = $("#filter-by-property-news  input[type='checkbox']:checked");
      ...
      if(filte_box2.length>0){
        filte_box2.each(function(){
          var text = $(this).val();
          var hold = $(".news-list-item.isVisible[data-newstyp*='" + text + "']");

          hold.addClass("isVisible_pass");

        });

        $(".news-list-item").removeClass("isVisible");
        $(".news-list-item.isVisible_pass").addClass("isVisible").removeClass("isVisible_pass");
      }
      if(filte_box2.length>1){
        $(".newsbtn span.changer").text(filte_box2.length+ ' options selected');
      }
      else{
        $(".newsbtn span.changer").text(filte_box2.length+ ' option selected');
      }


    });
  });
function optionvarify(filterbox,listName){
  
var varify = $(filterbox).data("varify");
var categoryarray = []; 

$(listName).each(function(){

var list = $(this).data(varify);
    var varifyArrray = list.split(",");

$.each(varifyArrray,function(ele){
var newr  = varifyArrray[ele].trim();
categoryarray.push(newr);
});
...
if(!categoryarray.includes(data)){
$(this).parents(".type-box").addClass("remove");
}
else{
$(this).parents(".type-box").removeClass("remove");
}

});
  $(filterbox+" .type-box.remove").remove();

}
if($("#category-filter").length>0){
optionvarify("#category-filter",".offer-box");
}
if($("#filter-by-topic").length>0){
optionvarify("#filter-by-topic",".event-block");
}
...
$(function() {
    // var storepoint  = "";
    drawMappintprint('hotel-1');
    $('a.marker').each(function() {
        var sel = $(this);
        var data_id = $(this).attr("data-id");
        var containHtml = $(".map_img_artmap .prop-info-block[data-id=" + data_id + "]").html();
		console.log('$(sel)', $(sel));
      /*  $(sel).tooltipster({
            contentAsHTML: true,
            content: containHtml,
   ...
   // $('a.marker').first().click();
});
$(window).on('resize', function() {
    drawMappintprint('hotel-1');
});

function drawMappintprint(imgType) {
    $(".imgmap").remove();
    var mappedImages = $("img[usemap]");
    mappedImages.each(function(index, img, img2) {
        var $img = $(img);
      var $img2 = $(img2);
        ...
        circles.each(function(index, circle) {
            ...
            var data_id = $circle.attr("data-id");
            var atrname = $circle.attr("data-atrname");
          	var althref = $circle.attr("data-href");
            var createPath = "https://web.archive.org/web/20230430081817/https://www.gaylordhotels.com/images_noindex/pin.png";
          	var createPath2 = "https://web.archive.org/web/20230430081817/https://www.gaylordhotels.com/images_noindex/pin2.png";
            var img = "<img class='resort-map-icon' alt='map-pin' width='19' height='19' src='" + createPath + "'>";
          var img2 = "<img class='resort-map-icon2' alt='map-pin2' width='19' height='19' src='" + createPath2 + "'>";
            var mapimg = "<span class='sr-only'>click to view'" + atrname + "' marker </span>";
            var onClk = "";
          var $name = '<span class="name" tabindex="-1">'+atrname+'</span>';
          if (isInIframe && isClinetLoggedIn > 0) {
            onClk = "onclick='getDynamicContentEditButtonjs();'";
            var $newa = $("<a " + onClk + " class='marker'  href='javascript:;' data-id='" + data_id +
                          "'>" + img + " " + img2 + mapimg +$name+ " </a>");
            $imgmap.append($newa);
          }
          else{
            var $newa = $("<a " + onClk + " class='marker' target='_blank' href='"+althref+"' data-id='" + data_id +
                          "'>" + img + " " + img2 + mapimg +$name+ " </a>");
            ...
            var sizeX = (attrs[2] - attrs[0]) + 'px';
            var sizeY = (attrs[3] - attrs[1]) + 'px';
            $newa.css({
                left: attrs[0] + 'px',
                top: attrs[1] + 'px',
                width: sizeX,
...
function outclick() {
    $(".map_img_artmap").click();
}

function getDynamicContentEditButtonjs() {
    setTimeout(function() {
        getDynamicContentEditButton_Component();
    }, 1000);
}
/**
  ...
  var methods = {
    init: function(options) {
      var o = $.extend({
        ...
        hrefTextPrefix: '#page-',
        hrefTextSuffix: '',
        prevText: '<i class="mim-icon-left-arrow-slider"><span class="sr-only">click on previous arrow</span></i>Prev',
        nextText: 'Next<i class="mim-icon-right-arrow-slider"><span class="sr-only">click on next arrow</span></i>',
        ellipseText: '&hellip;',
    ...
    _draw: function() {
      ...
      var $panel = this.prop("tagName") === "UL" ? this : $('<ul class="pagination-number explore-pagination uk-pagination"></ul>').appendTo(this);
...
var items = $(".state-page-list .properties-state-items.isSelected");
    ...
    $('#pagination-container').pagination({
        items: numItems,
        itemsOnPage: perPage,
        prevText: '<a href="javascript:;" class="prev-arrow"><span class="mim-icon-arrow"></span> <span class="sr-only">click on vacation sales previous arrow</span></a>',
        nextText: '<a href="javascript:;" class="next-arrow"><span class="mim-icon-right-arrow1"></span><span class="sr-only">click on vacation sales nexct arrow</span></a>',
...
/*
     FILE ARCHIVED ON 08:18:17 Apr 30, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 08:23:33 Apr 30, 2023.
...
/*
playback timings (ms):
  captures_list: 54.882
  exclusion.robots: 0.126
  exclusion.robots.policy: 0.112
  RedisCDXSource: 0.835
  esindex: 0.01
  LoadShardBlock: 36.561 (3)
  PetaboxLoader3.datanode: 34.4 (3)
  load_resource: 8.183
*/