...
(function($){var jQuery=$;Syn.Tracking={trackingModules:[]};Syn.Tracking.TrackLink={record:function(params)
...
{Syn.Config.Omniture={};}
if(typeof Syn.Config.Omniture.lockCount==='number'&&Syn.Config.Omniture.lockCount>0)
{Syn.Config.Omniture.lockCount-=1;}}};jQuery.fn.extend({registerTrackingModule:function(module){if($.inArray(module,this.trackingModules)<0){Syn.Tracking.trackingModules.push(module);}},unregisterTrackingModule:function(module){var position=$.inArray(module,this.trackingModules);if(position>-1){Syn.Tracking.trackingModules.splice(position,1);}},track:function(params)
...
var modules=params.module.split(',');var args=params.args;var ev_t=params.event;var live=params.live;var defer=params.defer;var toLower=params.toLower;var pageUri=params.pageUri;modules=modules.concat(Syn.Config.trackingModules);var module;var validModule=false;for(var ii in modules)
...
/*
     FILE ARCHIVED ON 07:40:52 Jul 20, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 07:41:03 Jul 20, 2023.
...
/*
playback timings (ms):
  captures_list: 128.598
  exclusion.robots: 0.106
  exclusion.robots.policy: 0.093
  RedisCDXSource: 0.672
  esindex: 0.009
  LoadShardBlock: 46.645 (3)
  PetaboxLoader3.datanode: 30.767 (3)
  load_resource: 23.474
*/