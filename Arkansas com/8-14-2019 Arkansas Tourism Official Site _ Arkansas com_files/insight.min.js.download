...
PixelLogger=function(d){function a(){return a.__super__.constructor.apply(this,arguments)}__extends(a,d);a.https_path="https://web.archive.org/web/20190814194445/https://px.ads.linkedin.com/insight_tag_errors.gif";a.log=function(b,c){var e,f;e=this.map_error_data(c,"&",encodeURIComponent);f=new Image(1,1);f.src=""+this.https_path+"?"+e;return f};return a}(BaseLogger);
...
/*
     FILE ARCHIVED ON 19:44:45 Aug 14, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 06:51:51 May 13, 2023.
...
playback timings (ms):
  ...
  esindex: 0.009
  LoadShardBlock: 153.816 (6)
  PetaboxLoader3.datanode: 132.337 (7)
  load_resource: 123.406
  PetaboxLoader3.resolve: 79.76
*/